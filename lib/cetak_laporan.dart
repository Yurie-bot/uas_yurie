...
class _CetakLaporanState extends State<CetakLaporan> {
  ...
  Future<void> ambilData() async {
    try {
      ...
      if (res.statusCode == 200) {
        ...
        setState(() {
          data = json.map((e) => hp.fromJson(e)).toList();
        });
      }
    } catch (e) {
  ...
  Future<void> hapus(String id) async {
    await http.post(Uri.parse("$baseUrl?op=delete"), body: {'kd_hp': id});
    ambilData();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Manajemen Data hp"),
        actions: [
          IconButton(
            ...
            onPressed: () async {
              await Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const Entrihp()),
              );
              ambilData();
            },
          ),
              ...
              child: SingleChildScrollView(
                ...
                child: SingleChildScrollView(
                  ...
                  child: DataTable(
                    ...
                    columns: const [
                      DataColumn(label: Text("Kode hp")),
                      DataColumn(label: Text("Foto")),
                      DataColumn(label: Text("Nama hp")),
  ...
  Future<pw.Document> _generatePdf(List<hp> data) async {
    ...
    final rows = <pw.TableRow>[
      pw.TableRow(
        children: [
          ...
          pw.Center(child:pw.Text("Nama hp")),
        ...
        build: (context) => [
          pw.Center(
            child: pw.Column(children: [
              pw.Text("CV. Tecnologi Handroid",
                  style: pw.TextStyle(
                      fontSize: 20, fontWeight: pw.FontWeight.bold)),
              pw.Text("Manajemen Data hp"),
          ...
          pw.Text("Total Stok hp: $totalStok"),
